        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-6">
          ...
          <div className="flex flex-col items-center md:items-center gap-4">
            ...
            <div className="flex space-x-4">
              <a href="#" className="hover:text-red-400 transition-colors"><i className="fab fa-facebook-f text-xl"></i></a>
              <a href="#" className="hover:text-red-400 transition-colors"><i className="fab fa-instagram text-xl"></i></a>
              <a href="#" className="hover:text-red-400 transition-colors"><i className="fab fa-linkedin-in text-xl"></i></a>
              <a href="#" className="hover:text-red-400 transition-colors"><i className="fab fa-twitter text-xl"></i></a>
            </div>
          </div>
